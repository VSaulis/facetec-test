// Welcome to the minimized FaceTec Device SDK code to launch User Sessions and retrieve 3D FaceScans and ID Scans (for further processing)!
...
class PhotoIDMatchProcessor_min_no_networking: NSObject, FaceTecFaceScanProcessorDelegate, FaceTecIDScanProcessorDelegate {
